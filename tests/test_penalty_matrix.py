...
class TestPenaltyMatrix(unittest.TestCase):
    ...
    def test_d1_difference_matrix(self): 
        ...
        self.assertEqual(self.d1.shape, (self.n_param-1, self.n_param))
    ...
    def test_d2_difference_matrix(self): 
        ...
        self.assertEqual(self.d2.shape, (self.n_param-2, self.n_param))
    ...
    def test_smoothness_matrix(self): 
        ...
        self.assertEqual(self.sm.shape, (self.n_param-2, self.n_param))
    ...
    def test_peak(self): 
        ...
        self.assertEqual(self.peak.shape, (self.n_param-1, self.n_param))
    ...
    def test_valley(self): 
        ...
        self.assertEqual(self.valley.shape, (self.n_param-1, self.n_param))
